...
class ClassMapGenerator
{
     ...
     *
     * @param array<string> $path         The path to search in or an iterator
     ...
     */
    public static function createMap($path, IOInterface $io = null, $namespace = null, $autoloadType = null, &$scannedFiles = array())
    {
        $basePath = $path;
        if (is_string($path)) {
            if (is_file($path)) {
