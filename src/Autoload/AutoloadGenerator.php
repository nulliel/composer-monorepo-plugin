...
EOF;
        ...
        $filesystem->filePutContentsIfModified($targetDir.'/autoload_real.php', $this->getAutoloadRealFile(true, (bool) $includePathFileContents, $targetDirLoader, (bool) $includeFilesFileContents, $vendorPathCode, $appBaseDirCode, $suffix, false, true, $staticPhpVersion, $checkPlatform));
...
FOOTER;
    ...
    private function getStaticFile($suffix, $targetDir, $vendorPath, $basePath): string
    {
        $file = <<<HEADER
<?php
